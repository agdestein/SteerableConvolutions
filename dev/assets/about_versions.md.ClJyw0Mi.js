import{_ as s,c as n,o as a,a7 as p}from"./chunks/framework.Bgl4Vzh_.js";const g=JSON.parse('{"title":"Package versions","description":"","frontmatter":{},"headers":[],"relativePath":"about/versions.md","filePath":"about/versions.md","lastUpdated":null}'),l={name:"about/versions.md"},e=p(`<h1 id="Package-versions" tabindex="-1">Package versions <a class="header-anchor" href="#Package-versions" aria-label="Permalink to &quot;Package versions {#Package-versions}&quot;">​</a></h1><h2 id="Julia-version" tabindex="-1">Julia version <a class="header-anchor" href="#Julia-version" aria-label="Permalink to &quot;Julia version {#Julia-version}&quot;">​</a></h2><p>The examples were generated with the following Julia version:</p><div class="language-julia vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">julia</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">using</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;"> InteractiveUtils</span></span>
...
<span class="line"><span>  [ec485272] ArnoldiMethod v0.4.0</span></span>
...
<span class="line"><span>  [13f3f980] CairoMakie v0.12.8</span></span>
<span class="line"><span>  [aafaddc9] CatIndices v0.2.2</span></span>
...
<span class="line"><span>  [aaaa29a8] Clustering v0.15.7</span></span>
...
<span class="line"><span>⌅ [c3611d14] ColorVectorSpace v0.9.10</span></span>
...
<span class="line"><span>  [ed09eef8] ComputationalResources v0.3.2</span></span>
...
<span class="line"><span>  [150eb455] CoordinateTransformations v0.6.3</span></span>
<span class="line"><span>  [adafc99b] CpuId v0.3.1</span></span>
<span class="line"><span>  [dc8bdbbb] CustomUnitRanges v1.0.2</span></span>
...
<span class="line"><span>  [b4f34e82] Distances v0.10.11</span></span>
...
<span class="line"><span>  [ee9a67c0] Examples v1.0.0 \`../examples\`</span></span>
<span class="line"><span>  [411431e0] Extents v0.1.4</span></span>
<span class="line"><span>  [4f61f5a4] FFTViews v0.3.2</span></span>
...
<span class="line"><span>  [86223c79] Graphs v1.11.2</span></span>
<span class="line"><span>  [3955a311] GridLayoutBase v0.11.0</span></span>
<span class="line"><span>  [42e2da0e] Grisu v1.0.2</span></span>
<span class="line"><span>  [2c695a8d] HistogramThresholding v0.3.1</span></span>
...
<span class="line"><span>⌃ [c817782e] ImageBase v0.1.5</span></span>
<span class="line"><span>  [cbc4b850] ImageBinarization v0.3.0</span></span>
<span class="line"><span>  [f332f351] ImageContrastAdjustment v0.3.12</span></span>
<span class="line"><span>⌅ [a09fc81d] ImageCore v0.9.4</span></span>
<span class="line"><span>  [89d5987c] ImageCorners v0.1.3</span></span>
<span class="line"><span>  [51556ac3] ImageDistances v0.2.17</span></span>
<span class="line"><span>⌃ [6a3955dd] ImageFiltering v0.7.6</span></span>
...
<span class="line"><span>  [787d08f9] ImageMorphology v0.4.5</span></span>
<span class="line"><span>  [2996bd0c] ImageQualityIndexes v0.3.7</span></span>
<span class="line"><span>⌃ [80713f31] ImageSegmentation v1.8.1</span></span>
<span class="line"><span>  [4e3cecfd] ImageShow v0.3.8</span></span>
<span class="line"><span>  [02fcd773] ImageTransformations v0.10.1</span></span>
...
<span class="line"><span>  [1d092043] IntegralArrays v0.1.5</span></span>
...
<span class="line"><span>  [ee78f7c6] Makie v0.21.8</span></span>
...
<span class="line"><span>  [626554b9] MetaGraphs v0.7.2</span></span>
...
<span class="line"><span>  [b8a86587] NearestNeighbors v0.4.18</span></span>
...
<span class="line"><span>⌅ [f27b6e38] Polynomials v3.2.4</span></span>
...
<span class="line"><span>  [94ee1d12] Quaternions v0.7.6</span></span>
...
<span class="line"><span>  [dee08c22] RegionTrees v0.3.2</span></span>
...
<span class="line"><span>  [6038ab10] Rotations v1.7.1</span></span>
...
<span class="line"><span>  [47aef6b3] SimpleWeightedGraphs v1.4.0</span></span>
...
<span class="line"><span>  [32a0adf6] SteerableConvolutions v1.0.0 \`..\`</span></span>
...
<span class="line"><span>  [06e1c1a7] TiledIteration v0.5.0</span></span>
...
<span class="line"><span>  [61579ee1] Ghostscript_jll v9.55.0+4</span></span>
...
<span class="line"><span>⌅ [c73af94c] ImageMagick_jll v6.9.13+0</span></span>
...
<span class="line"><span>⌅ [88015f11] LERC_jll v3.0.0+1</span></span>
...
<span class="line"><span>  [89763e89] Libtiff_jll v4.6.0+0</span></span>
<span class="line"><span>  [38a345b3] Libuuid_jll v2.40.1+0</span></span>
<span class="line"><span>  [d3a379c0] LittleCMS_jll v2.16.0+0</span></span>
...
<span class="line"><span>  [643b3616] OpenJpeg_jll v2.5.2+0</span></span>
...
<span class="line"><span>  [ffd25f8a] XZ_jll v5.4.6+0</span></span>
...
<span class="line"><span>  [3161d3a3] Zstd_jll v1.5.6+0</span></span>
